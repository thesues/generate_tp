...
/* vfs_lttng_init_search_op START*/
TRACEPOINT_EVENT(
    vfs_lttng,
    vfs_lttng_init_search_op_enter,
    TP_ARGS(
...
TRACEPOINT_EVENT(
    vfs_lttng,
    vfs_lttng_init_search_op_exit,
    TP_ARGS(
    ),
    TP_FIELDS(
    )
)
/* vfs_lttng_init_search_op END*/
...
/* vfs_lttng_read START*/
TRACEPOINT_EVENT(
    vfs_lttng,
    vfs_lttng_read_enter,
    TP_ARGS(
        files_struct *, fsp,
        size_t, n
    ),
...
/* vfs_lttng_write START*/
TRACEPOINT_EVENT(
    vfs_lttng,
    vfs_lttng_write_enter,
    TP_ARGS(
        files_struct *, fsp,
        size_t, n
    ),
...
/* vfs_lttng_chmod_acl START*/
TRACEPOINT_EVENT(
    vfs_lttng,
    vfs_lttng_chmod_acl_enter,
    TP_ARGS(
        const struct smb_filename *, smb_fname,
        mode_t, mode
    ),
...
/* vfs_lttng_chmod_acl END*/

/* vfs_lttng_fchmod_acl START*/
TRACEPOINT_EVENT(
    vfs_lttng,
    vfs_lttng_fchmod_acl_enter,
    TP_ARGS(
        files_struct *, fsp,
        mode_t, mode
    ),
